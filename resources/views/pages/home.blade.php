...
<main>
            ...
            >
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="card-travel text-center d-flex flex-column"
                        style="
                            background-image: url('frontend/images/populer-3.jpg');
                        "
                    >
                        <div class="travel-country">Indonesia</div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div
                        class="card-travel text-center d-flex flex-column"
                        style="
                            background-image: url('frontend/images/populer-4.jpg');
                        "
                    >
                        <div class="travel-country">Indonesia</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h2>Out Networks</h2>
                    <p>
                        Companies are trusted us <br />more than just a
                        trip
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    ...
                    <p>
                        Moments were giving them <br />the best
                        experience
                    </p>
                </div>
            </div>
    ...
    >
        <div class="container">
            <div
                class="section-upload-travel row justify-content-center"
            >
